        ...
        <div class="relative flex flex-col gap-[30px] my-[60px] px-5">
            ...
            <form action=""
                ...
                <div id="InputContainer" class="flex flex-col gap-[18px]">
                    ...
                    <button type="submit"
                class="flex w-full justify-center items-center rounded-full p-[14px_20px] 
                bg-[#FF7A00] hover:bg-[#e86c00] transition-all duration-300
                font-bold text-white text-lg shadow-md ring-2 ring-white ring-offset-2">
                Explore Now
            </button>
                </div>
            </form>
