                ...
                <a href="details.html" class="card">
                    <div
                        ...
                        <div class="flex flex-col gap-3">
                            <h3
                                class="font-semibold text-lg leading-[27px] line-clamp-2 min-h-[54px]">
                                Tumbuh {{ $boardingHouse->name }}
                            </h3>
                            ...
                            <div class="flex items-center gap-[6px]">
                                <img src="assets/images/icons/3dcube.svg" class="w-5 h-5" alt="icon">
                                <p class="text-sm text-ngekos-grey">{{ $boardingHouse->category->name }}</p>
                            </div>
                            <div class="flex items-center gap-[6px]">
                                <img src="assets/images/icons/profile-2user.svg" class="w-5 h-5" alt="icon">
...
<section id="Cities" class="flex flex-col p-5 gap-4 bg-[#F5F6F8] mt-[30px]">
    <div class="flex items-center justify-between">
        ...
        <a href="#">
            <div class="flex items-center gap-2">
                <span>See all</span>
                <img src="assets/images/icons/arrow-right.svg" class="w-6 h-6" alt="icon">
            </div>
        </a>
    </div>
    <div class="grid grid-cols-2 gap-4">
        ...
        <a href="{{ route('city.show', $city->slug) }}" class="card">
            <div
                ...
                <div
                    class="w-[55px] h-[55px] rounded-full border-4 border-white ring-1 ring-[#F1F2F6] overflow-hidden">
    ...
    <div class="flex flex-col gap-4">
        ...
        <a href="details.html" class="card">
            <div
                ...
                <div class="flex w-[120px] h-[183px] shrink-0 rounded-[30px] overflow-hidden">
                    <img src="{{ asset('storage/' . $boardingHouse->thumbnail) }}"
                        class="w-full h-full object-cover" alt="thumbnail">
                </div>
                <div class="flex flex-col gap-3 w-full">
                    <h3 class="font-semibold text-lg leading-[27px] line-clamp-2 min-h-[54px]">
                        Tumbuh Tentram {{ $boardingHouse->name }}
                    </h3>
                    <hr class="border-[#F1F2F6]">
                    <div class="flex items-center gap-[6px]">
                        <img src="assets/images/icons/location.svg" class="w-5 h-5" alt="icon">
